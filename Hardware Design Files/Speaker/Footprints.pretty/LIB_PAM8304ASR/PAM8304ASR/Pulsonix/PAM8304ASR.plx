...
(library Library_1
	...
	(compDef "PAM8304ASR" (originalName "PAM8304ASR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "PVDD") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "6" (pinName "__SD") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "IN+") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.diodes.com/assets/Datasheets/PAM8304.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "PAM8304ASR.stp")
